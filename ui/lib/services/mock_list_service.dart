  ...
  void _seedMockData() {
    ...
    _mockItems[list1Id] = [
      ...
      TierListItem(
        ...
        listId: list1Id,
        name: "Bleach",
        description: "Soul reapers fighting hollows",
        position: 8,
        rating: 6.8,
        tier: "B",
      ...
      TierListItem(
        ...
        listId: list1Id,
        name: "Dragon Ball Z",
        description: "Epic battles and power levels over 9000",
        position: 9,
        rating: 6.5,
        tier: "B",
        createdAt: DateTime.now().subtract(const Duration(days: 25)),
      ...
      TierListItem(
        ...
        listId: list1Id,
        name: "Fairy Tail",
        description: "A guild of magical misfits",
        position: 10,
        rating: 5.5,
        tier: "C",
      ...
      TierListItem(
        ...
        description: "Trapped in a virtual reality game",
        position: 11,
        rating: 5.2,
        tier: "C",
        createdAt: DateTime.now().subtract(const Duration(days: 24)),
      ...
      TierListItem(
        ...
        listId: list1Id,
        name: "Black Clover",
        description: "A boy without magic in a magical world",
        position: 12,
        rating: 4.8,
        tier: "C",
      ...
      TierListItem(
        ...
        listId: list1Id,
        name: "Tokyo Ghoul",
        description: "Half-human, half-ghoul struggles",
        position: 13,
        rating: 4.0,
        tier: "D",
      ...
      TierListItem(
        ...
        description: "Knights with a dark past",
        position: 14,
        rating: 3.5,
        tier: "D",
        createdAt: DateTime.now().subtract(const Duration(days: 22)),
      ...
      TierListItem(
        ...
        listId: list1Id,
        name: "School Days",
        description: "A romance gone horribly wrong",
        position: 15,
        rating: 1.2,
        tier: "F",
